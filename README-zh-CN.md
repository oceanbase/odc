...
| **方向**       | **Q1**                                                                                                                                                     | **Q2**                                                                                                                                                                                                        | **Q3**                                                                                                                   | **Q4**                                                                                   |
|--------------|------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|
| **SQL 开发**   | <ul><li>支持 Oracle 数据源</li><li>支持同构数据库结构比对/同步</li><li>内置常用代码片段</li></ul>                                                                                    | <ul><li>无锁结构变更支持写入限流</li><li>无锁结构变更适配 OB 内核 rename table 行为</li><li>提供无锁数据变更能力</li></ul>                                                                                                                      | <ul><li>优化 PL 开发体验（支持查看引用关系、根据</li><li>资源结构快速定位 PL 代码块、根据对象名跳转对应DDL等</li><li>数据库对象管理能力加强</li></ul>                       | <ul><li>支持异构数据库结构比对/同步</li><li>提供场景化测试数据构建能力</li></ul>                                   |
| **变更更风险管控**  | <ul><li>提供库级权限访问控制能力</li><li>自动识别 offline DDL 变更</li></ul>                                                                                                 | <ul><li>支持逻辑库 DDL 变更；</li><li>支持多库变更（pipeline 变更）</li><li>提供库管理员访问控制能力</li><li>提供表级权限访问控制能力</li><li>新增全局项目管理员角色</li></ul>                                                                                     | <ul><li>支持基于状态的结构变更</li><li>支持逻辑库 DML/DQL</li><li>支持模版化配置 SQL-check</li><li>提供基于行级回收站的变更回滚能力</li></ul>                   | <ul><li>命令行窗口行为纳入操作审计</li><li>提供敏感数据自动发现能力</li><li>提供数据轨迹能力</li><li>提供结构变更轨迹能力</li></ul> |
| **数据生命周期管理** | <ul><li>支持唯一索引表</li><li>支持 SQL 预览</li><li>支持同库归档</li><li>为 OB Oracle 提供分区计划能力</li><li>分区计划支持更多的字段类型</li><li>提升分区计划任务管理的易用性</li></ul>                       | <ul><li>支持从 OB 归档到文件/oss/s3</li><li>源端查询性能优化</li><li>防导爆能力加强</li><li>变量设置优化</li><li>支配任务运行时间段</li><li>支持按照索引顺序不分片进行数据处理</li><li>数据清理支持历史库数据校验</li><li>同构数据归档支持 DDL 增量变更同步</li></ul>                           | <ul><li>支持从OB归档到文件COS/OBS;</li><li>支持异构数据库归档表结构同步；</li><li>支持关联（外键）表场景进行归档；</li><li>数据归档/清理新建时提供风险提示能力；</li></ul>        | <ul><li>支持逻辑库</li><li>支持 Oracle 数据源</li></ul>                                            |
| **稳定性**      | <ul><li>优化任务框架（保障任务可靠调度）</li><li>支持任务异常发送告警</li></ul>                                                                                                      | -                                                                                                                                                                                                             | -                                                                                                                        | -                                                                                        |
| **易用性**      | <ul><li>SQL开发页签与资源树联动</li><li>库选择组件易用性提升</li><li>部分工单复制时支持参数编辑</li><li>支持自定义配置项（含快捷键等）</li><li>产品英文词条校验</li><li>桌面版内存占用优化至 1G 内</li><li>支持逻辑删除工单</li></ul> | <ul><li>工单管理优化（结束时间/进度/日志等）</li><li>计划（周期性）任务管理交互优化（工单状态/展示)</li><li>项目相关概念引导</li><li>资源树搜索能力优化及通过资源树发起工单</li><li>UI 主题焕新</li><li>SQL 窗口代码自动补全能力加强</li><li>运营指标体系建设</li><li>数据源、用户权限、外部集成模块产品英文词条校验</li></ul> | <ul><li>优化工单参数校验交互</li><li>桌面版启动速度优化至 20s 内</li><li>加强ODC自身任务的自助性（交互式排障指南/AI助手）</li><li>优化融脚本管理能力（批量下载、引用、分享等）</li></ul> | <ul><li>SQL 窗口提供模版化格式化能力</li><li>操作记录模块交互优化</li></ul>                                    |
| **AP**       | -                                                                                                                                                          | <ul><li>提供结果集图表能力</li><li>实时查询剖析</li><li>dbt-oceanbase插件开发</li></ul>                                                                                                                                          | <ul><li>提供全局元数据检索能力</li><li>宽表场景结果集交互优化</li><li>支持 Git 仓库集成</li><li>内置 dbt 开发能力</li><li>项目内脚本、代码片段协同</li></ul>           | <ul><li>ODC支持DAG任务编排</li><li>支持轻量报表管理（新建、智能生成、导出、分享等）</li></ul>                          |
| **AI**       | -                                                                                                                                                          | <ul><li>支持自然语言转化为 SQL</li></ul>                                                                                                                                                                               | <ul><li>支持自然语言转化为图表</li></ul>                                                                                            | <ul><li>支持 AI 任务编排</li></ul>                                                             |
