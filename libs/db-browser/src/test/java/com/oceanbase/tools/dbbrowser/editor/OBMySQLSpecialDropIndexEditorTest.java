...
/**
 * @description: all tests for {@link OBMySQLSpecialDropIndexEditor}
 * @author: zijia.cj
 * @date: 2025/4/2 21:04
 * @since: 4.3.4
 */
public class OBMySQLSpecialDropIndexEditorTest {
    ...
    public void setUp() throws Exception {
        indexEditor = new OBMySQLSpecialDropIndexEditor();
    }
    ...
    public void generateUpdateObjectDDL() {
        String casesJson =
                DBObjectUtilsTest.loadAsString(BASE_DIR + "/update_materialized_view_single_index_test_cases.json");
    ...
    public void generateUpdateIndexListDDL() {
        String casesJson =
                DBObjectUtilsTest.loadAsString(BASE_DIR + "/update_materialized_view_index_list_test_cases.json");
    ...
    public void generateDropObjectDDL() {
        String casesJson = DBObjectUtilsTest.loadAsString(BASE_DIR + "/drop_materialized_view_index_test_cases.json");
        List<DBObjectSingleTestCase<DBTableIndex>> cases =
                MySQLConstraintEditorTest.fromJson(casesJson,
                        new TypeReference<List<DBObjectSingleTestCase<DBTableIndex>>>() {});
        cases.forEach(testCase -> {
