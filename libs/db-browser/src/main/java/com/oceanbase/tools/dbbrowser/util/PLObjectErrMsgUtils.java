...
public class PLObjectErrMsgUtils {
    ...
    public static String getOraclePLObjErrMsg(JdbcOperations jdbcOperations, String owner, String objectType,
            String objectName) {
        return acquireErrorMessage(jdbcOperations, owner, objectType, objectName).getOrDefault(objectName, null);
    }

    public static Map<String, String> acquireErrorMessage(JdbcOperations jdbcOperations,
