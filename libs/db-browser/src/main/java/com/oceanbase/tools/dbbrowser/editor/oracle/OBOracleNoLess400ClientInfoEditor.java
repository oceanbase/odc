...
public class OBOracleNoLess400ClientInfoEditor implements DBClientInfoEditor {
    ...
    private final String SET_MODULE_TEMPLATE =
            "BEGIN DBMS_APPLICATION_INFO.SET_MODULE(module_name => '%s', action_name => '%s'); DBMS_APPLICATION_INFO.SET_CLIENT_INFO( '%s'); END";
    private final JdbcOperations jdbcOperations;

    public OBOracleNoLess400ClientInfoEditor(JdbcOperations jdbcOperations) {
