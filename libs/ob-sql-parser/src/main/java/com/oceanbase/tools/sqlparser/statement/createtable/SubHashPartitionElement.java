...
public class SubHashPartitionElement extends BaseSubPartitionElement {
    ...
    public SubHashPartitionElement(@NonNull ParserRuleContext context, @NonNull String relation) {
        super(context, relation);
    }

    public SubHashPartitionElement(@NonNull String relation) {
        super(relation);
    }
