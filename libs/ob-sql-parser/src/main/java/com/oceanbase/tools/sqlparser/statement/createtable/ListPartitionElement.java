...
public class ListPartitionElement extends BasePartitionElement {
    ...
    public ListPartitionElement(@NonNull ParserRuleContext context, String relation,
    ...
    public String toString() {
        ...
        builder.append(" VALUES(").append(this.listExprs.stream()
