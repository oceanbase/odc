...
public class MySQLCreateMaterializedViewFactory extends OBParserBaseVisitor<CreateMaterializedView> implements StatementFactory<CreateMaterializedView> {
     ...
     */
    @Override public CreateMaterializedView visitCreate_mview_opts(Create_mview_optsContext ctx) {
        ...
        if(Objects.nonNull(ctx.REWRITE())&&Objects.nonNull(ctx.COMPUTATION())){
            if(ctx.REWRITE().getSymbol().getStartIndex()<ctx.COMPUTATION().getSymbol().getStartIndex()){
                createMaterializedViewOpts.setEnableQueryRewrite(true);
                createMaterializedViewOpts.setEnableQueryComputation(false);
            }
     ...
     * {@link #visitChildren} on {@code ctx}.</p>
     */
    @Override public CreateMaterializedView visitMview_enable_disable(Mview_enable_disableContext ctx) {
        return visitChildren(ctx); }
    /**
     * {@inheritDoc}
     *
     ...
     * {@link #visitChildren} on {@code ctx}.</p>
     */
    @Override public CreateMaterializedView visitMview_refresh_opt(Mview_refresh_optContext ctx) {
        return visitChildren(ctx); }
    /**
     * {@inheritDoc}
     *
     ...
     * {@link #visitChildren} on {@code ctx}.</p>
     */
    @Override public CreateMaterializedView visitMv_refresh_on_clause(Mv_refresh_on_clauseContext ctx) {
        return visitChildren(ctx); }
    /**
     * {@inheritDoc}
     *
     ...
     * {@link #visitChildren} on {@code ctx}.</p>
     */
    @Override public CreateMaterializedView visitMv_refresh_method(Mv_refresh_methodContext ctx) {
        return visitChildren(ctx); }
    /**
     * {@inheritDoc}
     *
     ...
     * {@link #visitChildren} on {@code ctx}.</p>
     */
    @Override public CreateMaterializedView visitMv_refresh_mode(Mv_refresh_modeContext ctx) {
        return visitChildren(ctx); }
    /**
     * {@inheritDoc}
     *
     ...
     * {@link #visitChildren} on {@code ctx}.</p>
     */
    @Override public CreateMaterializedView visitMv_refresh_interval(Mv_refresh_intervalContext ctx) {
        return visitChildren(ctx); }
    /**
     * {@inheritDoc}
     *
     ...
     * {@link #visitChildren} on {@code ctx}.</p>
     */
    @Override public CreateMaterializedView visitMv_start_clause(Mv_start_clauseContext ctx) {
        return visitChildren(ctx); }
    /**
     * {@inheritDoc}
     *
     ...
     * {@link #visitChildren} on {@code ctx}.</p>
     */
    @Override public CreateMaterializedView visitMv_next_clause(Mv_next_clauseContext ctx) {
        return visitChildren(ctx); }
