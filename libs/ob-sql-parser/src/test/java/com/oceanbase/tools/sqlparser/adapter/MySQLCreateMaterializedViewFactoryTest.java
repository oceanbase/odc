...
public class MySQLCreateMaterializedViewFactoryTest {
    ...
    public void generate_CreateMaterializedViewOpts_generateSucceed() {
        ...
        MaterializedViewRefreshOpts materializedViewRefreshOpts1 =
                new MaterializedViewRefreshOpts("COMPLETE", new MaterializedViewRefreshInterval("sysdate()", 1L, "DAY"),
                        new MaterializedViewRefreshOnClause("DEMAND"));
        CreateMaterializedViewOpts createMaterializedViewOpts1 =
                new CreateMaterializedViewOpts(false, false, materializedViewRefreshOpts1);
        ...
        MaterializedViewRefreshOpts materializedViewRefreshOpts2 =
                new MaterializedViewRefreshOpts("COMPLETE", new MaterializedViewRefreshInterval("sysdate()", 1L, "DAY"),
                        new MaterializedViewRefreshOnClause("DEMAND"));
        CreateMaterializedViewOpts createMaterializedViewOpts2 =
                new CreateMaterializedViewOpts(false, true, materializedViewRefreshOpts2);
