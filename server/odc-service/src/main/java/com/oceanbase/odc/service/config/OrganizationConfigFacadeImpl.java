...
public class OrganizationConfigFacadeImpl implements OrganizationConfigFacade {
    ...
    @Override
    public Integer getDefaultQueryNumber() {
        return Integer.parseInt(getOrganizationConfig(OrganizationConfigKeys.DEFAULT_QUERY_COUNT));
    }

    @Override
    public boolean getDefaultRollbackPlan() {
        return getOrganizationConfig(OrganizationConfigKeys.DEFAULT_ROLLBACK_PLAN_ENABLED).equalsIgnoreCase("false");
    }
