...
/**
 * {@link NotNullColumnWithoutDefaultValue}
 *
 * @author yh263208
 * @date 2023-06-27 20:37
 * @since ODC_release_4.2.0
 */
public class NotNullColumnWithoutDefaultValue implements SqlCheckRule {

    @Override
    public SqlCheckRuleType getType() {
        return SqlCheckRuleType.NOT_NULL_COLUMN_WITHOUT_DEFAULT_VALUE;
    }
    ...
    private List<CheckViolation> builds(String sql, Stream<ColumnDefinition> stream) {
        return stream.filter(d -> {
            ...
            List<InLineConstraint> cs = ca.getConstraints();
