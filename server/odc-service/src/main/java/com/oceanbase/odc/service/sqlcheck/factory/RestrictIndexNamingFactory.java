...
public class RestrictIndexNamingFactory implements SqlCheckRuleFactory {
    ...
    public SqlCheckRule generate(@NonNull DialectType dialectType, Map<String, Object> parameters) {
        ...
        if (parameters == null || parameters.isEmpty() || parameters.get(key) == null) {
            return new RestrictIndexNaming(null);
        }
        return new RestrictIndexNaming(parameters.get(key).toString());
    }
