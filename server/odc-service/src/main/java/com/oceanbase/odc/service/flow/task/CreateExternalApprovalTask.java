...
public class CreateExternalApprovalTask extends BaseFlowableDelegate {
    ...
    protected void run(DelegateExecution execution) throws Exception {
        ...
        FlowApprovalInstance flowApprovalInstance = instanceOpt.get();
        Long externalApprovalId = flowApprovalInstance.getExternalApprovalId();
        if (Objects.nonNull(externalApprovalId)) {
            log.info("Start create external approval instance, flowApprovalInstanceId={}, externalApprovalId={}",
                    flowApprovalInstance.getId(), externalApprovalId);
            ...
            try {
                ...
                log.info("Create external approval instance success, flowApprovalInstanceId={}, externalApprovalId={}",
                        flowApprovalInstance.getId(), externalApprovalId);
                ...
                log.warn(
                        "Create external approval instance failed, the flow instance is coming to an end, flowApprovalInstanceId={}, externalApprovalId={}",
