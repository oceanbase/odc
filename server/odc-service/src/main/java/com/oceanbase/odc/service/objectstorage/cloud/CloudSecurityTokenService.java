 ...
 * Cloud STS Service
 */
public interface CloudSecurityTokenService {
    UploadObjectTemporaryCredential generateTempCredential(@NotBlank String bucketName, @NotBlank String objectName,
            @NotNull Long durationSeconds) throws CloudException;
}
