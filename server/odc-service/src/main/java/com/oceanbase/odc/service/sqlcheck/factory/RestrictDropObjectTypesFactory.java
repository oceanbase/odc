...
public class RestrictDropObjectTypesFactory implements SqlCheckRuleFactory {
    ...
    public SqlCheckRule generate(@NonNull DialectType dialectType, Map<String, Object> parameters) {
        ...
        return new RestrictDropObjectTypes(new HashSet<>((List<String>) parameters.get(key)));
    }
