...
/**
 * {@link MySQLMissingRequiredColumns}
 *
 * @author yh263208
 * @date 2023-06-27 15:58
 * @since ODC_release_4.2.0
 */
public class MySQLMissingRequiredColumns extends BaseMissingRequiredColumns {

    public MySQLMissingRequiredColumns(@NonNull Set<String> requiredColumns) {
