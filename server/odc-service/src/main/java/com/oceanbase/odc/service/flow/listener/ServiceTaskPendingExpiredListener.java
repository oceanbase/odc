 ...
 */
@Slf4j
public class ServiceTaskPendingExpiredListener extends BaseStatusModifyListener<FlowTaskInstance> {
    ...
    /**
     * since the {@link org.flowable.bpmn.model.TimerEventDefinition} in
    ...
    protected FlowNodeStatus doModifyStatusOnEnd(FlowTaskInstance target) {
        flowInstanceRepository.updateStatusById(target.getFlowInstanceId(), FlowStatus.WAIT_FOR_EXECUTION_EXPIRED);
