...
public class LogicalDatabaseChangeFlowableTask extends BaseODCFlowTaskDelegate<Void> {
    ...
    protected void onSuccessful(Long taskId, TaskService taskService) {
        log.info("Logical database change task succeed, taskId={}", taskId);
    ...
    protected void onFailure(Long taskId, TaskService taskService) {
        log.warn("Logical database change task failed, taskId={}", taskId);
        super.onFailure(taskId, taskService);
    }

    @Override
    protected void onTimeout(Long taskId, TaskService taskService) {
        log.warn("Logical database change task timeout, taskId={}", taskId);
