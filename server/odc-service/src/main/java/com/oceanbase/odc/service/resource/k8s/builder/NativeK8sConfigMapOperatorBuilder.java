 ...
 *
 * @author yh263208
 * @date 2024-09-03 14:47
 * @since ODC_release_4.3.2
 */
@Component
public class NativeK8sConfigMapOperatorBuilder extends BaseNativeK8sResourceOperatorBuilder<V1ConfigMap> {
    ...
    @Override
    public ResourceOperator<V1ConfigMap> build(@NonNull ResourceOperatorTag resourceOperatorTag) {
        return new NativeK8sConfigMapOperator(this.defaultNamespace);
    }
