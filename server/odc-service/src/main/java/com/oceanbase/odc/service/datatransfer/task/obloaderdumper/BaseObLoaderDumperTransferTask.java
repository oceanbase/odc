 ...
 */
@Slf4j
public abstract class BaseObLoaderDumperTransferTask<T extends BaseParameter> extends BaseDataTransferTask
    ...
    public static DataTransferTaskContext start(@NonNull ThreadPoolTaskExecutor executor,
            @NonNull BaseObLoaderDumperTransferTask<? extends BaseParameter> task) {
