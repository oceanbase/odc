...
public interface SensitiveRuleMapper {
    ...
    SensitiveRuleMapper INSTANCE = Mappers.getMapper(SensitiveRuleMapper.class);

    SensitiveRule entityToModel(SensitiveRuleEntity entity);

    SensitiveRuleEntity modelToEntity(SensitiveRule model);
