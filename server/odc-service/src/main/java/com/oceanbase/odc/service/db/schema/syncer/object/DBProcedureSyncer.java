 ...
 */
@Component
public class DBProcedureSyncer extends AbstractDBObjectSyncer<ProcedureExtensionPoint> {

    @Override
    protected Set<String> getLatestObjectNames(@NonNull ProcedureExtensionPoint extensionPoint,
    ...
    @Override
    Class<ProcedureExtensionPoint> getExtensionPointClass() {
        return ProcedureExtensionPoint.class;
    }
