...
/**
 * {@link OracleRestrictPKDataTypes}
 *
 * @author yh263208
 * @date 2023-06-19 17:54
 * @since ODC_release_4.2.0
 */
public class OracleRestrictPKDataTypes extends BaseRestrictPKDataTypes {

    public OracleRestrictPKDataTypes(JdbcOperations jdbcOperations, @NonNull Set<String> allowedTypeNames) {
