...
/**
 * {@link MySQLRestrictIndexDataTypes}
 *
 * @author yh263208
 * @date 2023-06-28 17:52
 * @since ODC_release_4.2.0
 */
public class MySQLRestrictIndexDataTypes extends BaseRestrictIndexDataTypes {

    public MySQLRestrictIndexDataTypes(JdbcOperations jdbcOperations, @NonNull Set<String> allowedTypeNames) {
