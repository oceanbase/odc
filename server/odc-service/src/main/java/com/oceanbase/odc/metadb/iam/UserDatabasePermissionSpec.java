...
public class UserDatabasePermissionSpec {
    ...
    public static Specification<UserDatabasePermissionEntity> authorizationTypeEqual(
            AuthorizationType authorizationTypes) {
        return SpecificationUtil.columnEqual(UserDatabasePermissionEntity_.AUTHORIZATION_TYPE, authorizationTypes);
    }

    public static Specification<UserDatabasePermissionEntity> expireTimeBefore(Date date) {
        return SpecificationUtil.columnBefore(UserDatabasePermissionEntity_.EXPIRE_TIME, date);
    }

    public static Specification<UserDatabasePermissionEntity> expireTimeLate(Date date) {
