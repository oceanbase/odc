...
public interface AuditEventHandler {
    ...
    void handle(List<AuditEventEntity> events, HttpServletRequest servletRequest);

    List<AuditEventMeta> filterAuditEventMeta(List<AuditEventMeta> actualEventMetas);
