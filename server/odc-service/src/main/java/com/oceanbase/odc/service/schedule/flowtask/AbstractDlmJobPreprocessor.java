...
public class AbstractDlmJobPreprocessor implements Preprocessor {
    ...
    public void checkDatasource(ConnectionConfig datasource) {
        ...
        // if (datasource.getDialectType().isOceanbase() &&
        // StringUtils.isEmpty(datasource.getClusterName())) {
        // throw new UnsupportedException(
        // "DLM currently does not support tenant instances. Please configure the cluster information and
        // try again.");
        // }
    }
