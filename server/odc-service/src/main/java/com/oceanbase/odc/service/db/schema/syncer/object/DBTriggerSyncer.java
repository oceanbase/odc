 ...
 */
@Component
public class DBTriggerSyncer extends AbstractDBObjectSyncer<TriggerExtensionPoint> {

    @Override
    protected Set<String> getLatestObjectNames(@NonNull TriggerExtensionPoint extensionPoint,
    ...
    @Override
    Class<TriggerExtensionPoint> getExtensionPointClass() {
        return TriggerExtensionPoint.class;
    }
