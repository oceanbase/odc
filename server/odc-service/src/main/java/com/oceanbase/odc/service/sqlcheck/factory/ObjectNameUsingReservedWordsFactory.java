...
public class ObjectNameUsingReservedWordsFactory implements SqlCheckRuleFactory {
    ...
    public SqlCheckRule generate(@NonNull SqlCheckRuleContext sqlCheckRuleContext) {
        return sqlCheckRuleContext.getDialectType().isMysql()
                ? new MySQLObjectNameUsingReservedWords()
                : new OracleObjectNameUsingReservedWords();
    }
