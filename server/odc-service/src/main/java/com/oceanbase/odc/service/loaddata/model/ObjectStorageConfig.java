...
public class ObjectStorageConfig {
    ...
    // https://cloud.baidu.com/doc/BOS/s/xjwvyq9l4 baidu cloud aws compatible only bj and su region
    // support https
    // so we use http instead of https
    private static final String BAIDU_ENDPOINT_PATTERN = "http://s3.{0}.bcebos.com";
    ...
    public static String concatEndpoint(CloudProvider cloudProvider, String component) {
        switch (cloudProvider) {
            ...
            case BAIDU_CLOUD:
                return MessageFormat.format(BAIDU_ENDPOINT_PATTERN, retrieveBaiduCloudRegion(component));
            case AWS:
            case AWSCN:
    ...
    public static String retrieveBaiduCloudRegion(String region) {
