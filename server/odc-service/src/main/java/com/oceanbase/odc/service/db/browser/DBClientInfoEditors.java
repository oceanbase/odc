...
import com.oceanbase.tools.dbbrowser.editor.DBClientInfoEditorFactory;

public class DBClientInfoEditors {

    public static DBClientInfoEditor create(ConnectionSession connectionSession, String jdbcExecutor) {
        ...
        SyncJdbcExecutor syncJdbcExecutor =
                connectionSession.getSyncJdbcExecutor(jdbcExecutor);
        ...
        return new DBClientInfoEditorFactory()
