...
@Component
@Slf4j
public class DefaultConnectionSSLAdaptor implements ConnectionSSLAdaptor {
    ...
    public <T extends SSLConnectionConfig> T adapt(@NonNull T connection) {
        ...
        connection.setSslFileEntry(SSLFileEntry.builder()
                ...
                .build());
        log.info("================getKeyStoreFilePath:{}", connection.getSslFileEntry().getKeyStoreFilePath());
        log.info("================keyStoreFilePassword:{}", connection.getSslFileEntry().getKeyStoreFilePassword());
        return connection;
    }
