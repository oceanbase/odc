...
public class TableNameInBlackListFactory implements SqlCheckRuleFactory {
    ...
    public SqlCheckRule generate(@NonNull DialectType dialectType, Map<String, Object> parameters) {
        ...
        if (parameters == null || parameters.isEmpty() || parameters.get(key) == null) {
            return new TableNameInBlackList(new HashSet<>());
        }
        return new TableNameInBlackList(new HashSet<>((List<String>) parameters.get(key)));
    }
