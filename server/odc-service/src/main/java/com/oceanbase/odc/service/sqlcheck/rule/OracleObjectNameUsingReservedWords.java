...
/**
 * {@link OracleObjectNameUsingReservedWords}
 *
 * @author yh263208
 * @date 2024-03-05 17:13
 * @since ODC_release_4.2.4
 */
public class OracleObjectNameUsingReservedWords extends BaseObjectNameUsingReservedWords {

    private static final String RESERVED_WORDS_FILE = "sql-check/oboracle-reserved-words.yml";
    ...
    protected boolean isReservedWords(String objectName) {
        ...
        return RESERVED_WORDS.contains(StringUtils.unquoteOracleIdentifier(objectName).toLowerCase());
    }
