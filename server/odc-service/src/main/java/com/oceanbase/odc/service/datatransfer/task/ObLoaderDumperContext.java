 ...
 */
@Getter
public class ObLoaderDumperContext implements Future<DataTransferTaskResult> {
    ...
    ObLoaderDumperContext(@NonNull Future<DataTransferTaskResult> handle) {
        this.handle = handle;
    }
