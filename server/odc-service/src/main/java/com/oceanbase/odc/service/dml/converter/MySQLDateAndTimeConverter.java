...
/**
 * {@link MySQLDateAndTimeConverter}
 *
 * @author yh263208
 * @date 2022-06-26 16:21
 * @since ODC_release_3.4.0
 */
public class MySQLDateAndTimeConverter extends BaseDataConverter {

    @Override
    protected Collection<String> getSupportDataTypeNames() {
        return Arrays.asList("time", "timestamp", "date", "datetime", "year");
    }
