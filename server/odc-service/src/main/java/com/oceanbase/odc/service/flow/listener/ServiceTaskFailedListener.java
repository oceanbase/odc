...
/**
 * Execute the listener when the task execution fails, and set the task status to failed
 *
 * @author yh263208
 * @date 2022-03-01 15:40
 * @since ODC_release_3.3.0
 * @see BaseStatusModifyListener
 */
@Slf4j
public class ServiceTaskFailedListener extends BaseStatusModifyListener<FlowTaskInstance> {
    ...
    protected FlowNodeStatus doModifyStatusOnEnd(FlowTaskInstance target) {
        flowInstanceRepository.updateStatusById(target.getFlowInstanceId(), FlowStatus.EXECUTION_FAILED);
