...
public class RestrictTableAutoIncrementFactory implements SqlCheckRuleFactory {
    ...
    public SqlCheckRule generate(@NonNull DialectType dialectType, Map<String, Object> parameters) {
        ...
        return (dialectType.isMysql() || dialectType.isDoris()) ? new MySQLRestrictTableAutoIncrement(initValue) : null;
    }
}
