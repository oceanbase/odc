...
public class PathTest {
    ...
    public PathTest(String method, String path1, String path2, Integer expectedResult,
            ...
            String path, ProjectFileLocation expectedLocation, ProjectFileType expectedType, String expectedName,
    ...
    public static Iterable<Object[]> data() {
        return Arrays.asList(new Object[][] {
                ...
                {"testConstructor", null, null, null, "Worksheets / path2 / file.txt ", ProjectFileLocation.WORKSHEETS,
                        ProjectFileType.FILE, "file.txt", 3,
                        "/Worksheets/path2/file.txt", Arrays.asList("Worksheets", "path2", "/")},
                {"testConstructor", null, null, null, "Worksheets \\ path2 \\  ", ProjectFileLocation.WORKSHEETS,
                        ProjectFileType.DIRECTORY, "path2", 2,
                        "/Worksheets/path2/", Arrays.asList("Worksheets", "/")},
                {"testConstructor", null, null, null, "Worksheets /  ", ProjectFileLocation.WORKSHEETS,
                        ProjectFileType.DIRECTORY, "Worksheets", 1,
                        "/Worksheets/", Arrays.asList("/")},
                {"testConstructor", null, null, null, "Worksheets / path2 / file.txt ", ProjectFileLocation.WORKSHEETS,
                        ProjectFileType.FILE, "file.txt", 3,
                        "/Worksheets/path2/file.txt", Arrays.asList("Worksheets", "path2", "/")},
                {"testConstructor", null, null, null, " /Repos/git \\ ", ProjectFileLocation.REPOS,
                        ProjectFileType.GIT_REPO, "git", 2, "/Repos/git/", Arrays.asList("Repos", "/")},
                {"testConstructor", null, null, null, " \\Repos/git / folder1/   ", ProjectFileLocation.REPOS,
                        ProjectFileType.DIRECTORY, "folder1", 3,
                        "/Repos/git/folder1/", Arrays.asList("Repos", "git", "/")},
                {"testConstructor", null, null, null, " Repos/git \\ file1   ", ProjectFileLocation.REPOS,
                        ProjectFileType.FILE, "file1", 3,
                        "/Repos/git/file1", Arrays.asList("Repos", "git", "/")},
                {"testConstructor", null, null, null, "/Repos/path2/", ProjectFileLocation.REPOS,
                        ProjectFileType.GIT_REPO, "path2", 2, "/Repos/path2/", Arrays.asList("Repos", "/")},
                {"testConstructor", null, null, null, "//   ///  ///Repos/  ///  //path2///  /",
                        ProjectFileLocation.REPOS, ProjectFileType.GIT_REPO, "path2", 2,
                ...
                {"testGetParentPath", null, null, null, "Worksheets \\ path2 \\  ", ProjectFileLocation.WORKSHEETS,
                        ProjectFileType.DIRECTORY, "Worksheets", 1,
                        null, Arrays.asList("/")},
                ...
                {"testGetParentPath", null, null, null, " \\Repos/git / folder1/   ", ProjectFileLocation.REPOS,
                        ProjectFileType.GIT_REPO, "git", 2,
                        null, Arrays.asList("Repos", "/")},
                {"testGetParentPath", null, null, null, " \\Repos/git / folder1/file1   ", ProjectFileLocation.REPOS,
                        ProjectFileType.DIRECTORY, "folder1", 3,
