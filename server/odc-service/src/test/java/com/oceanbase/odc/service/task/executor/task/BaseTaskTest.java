    ...
    public void testExceptionListenerWithException() {
        try (MockedStatic<SystemUtils> mockSystemUtil = Mockito.mockStatic(SystemUtils.class)) {
            ...
            Assert.assertEquals(taskResult.getErrorMessage(),
                    " \tat com.oceanbase.odc.service.task.executor.task.BaseTask.start(BaseTask.java:76) \tat com.oceanbase.odc.service.task.executor.task.BaseTaskTest$DummyBaseTask.doStart(BaseTaskTest.java:114) java.lang.IllegalStateException: exception should be thrown");
        }
    }
