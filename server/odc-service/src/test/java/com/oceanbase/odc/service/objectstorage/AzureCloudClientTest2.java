 ...
 */
public class AzureCloudClientTest2 {
    ...
    public void testBucketExits() {
        ...
        Assert.assertTrue(azureCloudClient.doesBucketExist("ssssss"));
    }

    @Test
    public void testGetLocation() {
        Assert.assertNull(azureCloudClient.getBucketLocation("odccontainer"));
    }
}
