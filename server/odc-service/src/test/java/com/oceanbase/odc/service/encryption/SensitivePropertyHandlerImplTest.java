...
public class SensitivePropertyHandlerImplTest {

    private SensitivePropertyHandlerImpl enabledHandler = new SensitivePropertyHandlerImpl(true);
    private SensitivePropertyHandlerImpl disabledHandler = new SensitivePropertyHandlerImpl(false);
