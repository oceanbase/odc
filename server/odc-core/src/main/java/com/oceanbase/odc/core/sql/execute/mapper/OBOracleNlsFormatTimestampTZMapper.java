...
/**
 * {@link OBOracleNlsFormatTimestampTZMapper}
 *
 * @author yh263208
 * @date 2023-07-04 21:02
 * @since ODC_release_4.2.0
 */
public class OBOracleNlsFormatTimestampTZMapper extends OracleGeneralTimestampTZMapper {

    private final OracleTimestampFormat format;

    public OBOracleNlsFormatTimestampTZMapper(@NonNull String pattern) {
