...
/**
 * {@link OBOracleAstFactory}
 *
 * @author yh263208
 * @date 2023-11-17 15:52
 * @since ODC_release_4.2.3
 * @see BaseOBAstFactory
 */
class OBOracleAstFactory extends BaseOBAstFactory {

    public OBOracleAstFactory(long timeoutMillis) {
        super(timeoutMillis);
    }
    ...
    protected AbstractSyntaxTree doBuildAst(ParseTree parseTree,
        ...
        return new OBOracleAst(parseTree, from);
    }
