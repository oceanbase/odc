...
public class BinaryVirtualElement implements VirtualElement {
    ...
    private final BinaryContentMetaData metaData;

    public BinaryVirtualElement(@NonNull String tableId,
            @NonNull Long rowId,
