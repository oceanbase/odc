...
@Slf4j
public class FirstTestAuthorizer implements Authorizer {
    private final boolean finalResult;
    private final boolean terminted;
    private final boolean privileged;

    public FirstTestAuthorizer(boolean finalResult, boolean terminted, boolean privileged) {
    ...
    public boolean isPermitted(Principal principal, Collection<Permission> permissions, SecurityContext context) {
        log.info("Begin to checkPermission for DefaultAuthorizerOne, principal={}, permissions={}, context={}",
