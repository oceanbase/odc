...
import com.oceanbase.odc.plugin.task.obmysql.partitionplan.mapper.CellDataProcessors.EmptyCellDataProcessor;
import com.oceanbase.tools.dbbrowser.model.datatype.DataType;

import lombok.NonNull;

/**
 * {@link com.oceanbase.odc.plugin.task.obmysql.partitionplan.mapper.CellDataProcessors}
 *
 * @author yh263208
...
public class CellDataProcessors {
    ...
    static {
        PROCESSORS.add(new OBOracleDateTypeProcessor());
        PROCESSORS.add(new OBOracleTimestampTypeProcessor());
    }
