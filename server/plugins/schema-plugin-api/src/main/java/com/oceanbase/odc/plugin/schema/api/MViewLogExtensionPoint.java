 ...
 * @description:
 * @author: zijia.cj
 * @date: 2025/7/15 08:23
 * @since: 4.4.0
 */
public interface MViewLogExtensionPoint extends ExtensionPoint {

    List<DBObjectIdentity> list(Connection connection, String schemaName);

    DBMaterializedViewLog getDetail(Connection connection, String schemaName, String mViewName);
