...
/**
 * ClassName: DorisTraceExtension Package: com.oceanbase.odc.plugin.connect.doris Description:
 *
 * @Author: fenghao
 * @Create 2024/1/8 10:07
 * @Version 1.0
 */
@Slf4j
@Extension
public class DorisTraceExtension implements TraceExtensionPoint {
    @Override
