...
values ('common.schema.version', '7.1.0.2', 1) ON DUPLICATE KEY UPDATE `NAME_`= `NAME_`;

insert into ACT_GE_PROPERTY
values ('next.dbid', '1', 1)  ON DUPLICATE KEY UPDATE `NAME_`= `NAME_`;
...
alter table if exists ACT_RU_JOB
  add constraint if not exists ACT_FK_JOB_EXCEPTION
...
alter table if exists ACT_RU_TIMER_JOB
  add constraint if not exists ACT_FK_TIMER_JOB_EXCEPTION
    foreign key (EXCEPTION_STACK_ID_)
      references ACT_GE_BYTEARRAY (ID_);
...
alter table if exists ACT_RU_SUSPENDED_JOB
  add constraint if not exists ACT_FK_SUSPENDED_JOB_EXCEPTION
    foreign key (EXCEPTION_STACK_ID_)
      references ACT_GE_BYTEARRAY (ID_);
...
alter table if exists ACT_RU_DEADLETTER_JOB
  add constraint if not exists ACT_FK_DEADLETTER_JOB_EXCEPTION
    foreign key (EXCEPTION_STACK_ID_)
      references ACT_GE_BYTEARRAY (ID_);
...
alter table if exists ACT_RU_VARIABLE
  add constraint if not exists ACT_FK_VAR_BYTEARRAY
...
create table if not exists ACT_EVT_LOG (
                                         LOG_NR_ bigint generated by default as identity ,
                                         TYPE_ varchar(64),
                                         PROC_DEF_ID_ varchar(64),
                                         PROC_INST_ID_ varchar(64),
                                         EXECUTION_ID_ varchar(64),
...
alter table if exists ACT_GE_BYTEARRAY
  add constraint if not exists ACT_FK_BYTEARR_DEPL
    foreign key (DEPLOYMENT_ID_)
      references ACT_RE_DEPLOYMENT;

alter table if exists ACT_RE_PROCDEF
  add constraint if not exists ACT_UNIQ_PROCDEF
    unique (KEY_,VERSION_, DERIVED_VERSION_, TENANT_ID_);

alter table if exists ACT_RU_EXECUTION
  add constraint if not exists ACT_FK_EXE_PROCINST
    foreign key (PROC_INST_ID_)
      references ACT_RU_EXECUTION;

alter table if exists ACT_RU_EXECUTION
  add constraint if not exists ACT_FK_EXE_PARENT
    foreign key (PARENT_ID_)
      references ACT_RU_EXECUTION;

alter table if exists ACT_RU_EXECUTION
  add constraint if not exists ACT_FK_EXE_SUPER
    foreign key (SUPER_EXEC_)
      references ACT_RU_EXECUTION;

alter table if exists ACT_RU_EXECUTION
  add constraint if not exists ACT_FK_EXE_PROCDEF
    foreign key (PROC_DEF_ID_)
      references ACT_RE_PROCDEF (ID_);

alter table if exists ACT_RU_IDENTITYLINK
  add constraint if not exists ACT_FK_TSKASS_TASK
    foreign key (TASK_ID_)
      references ACT_RU_TASK;

alter table if exists ACT_RU_IDENTITYLINK
  add constraint if not exists ACT_FK_ATHRZ_PROCEDEF
    foreign key (PROC_DEF_ID_)
      references ACT_RE_PROCDEF;

alter table if exists ACT_RU_IDENTITYLINK
  add constraint if not exists ACT_FK_IDL_PROCINST
    foreign key (PROC_INST_ID_)
...
alter table if exists ACT_RU_TASK
  add constraint if not exists ACT_FK_TASK_PROCINST
    foreign key (PROC_INST_ID_)
      references ACT_RU_EXECUTION;

alter table if exists ACT_RU_TASK
  add constraint if not exists ACT_FK_TASK_PROCDEF
    foreign key (PROC_DEF_ID_)
      references ACT_RE_PROCDEF;

alter table if exists ACT_RU_VARIABLE
  add constraint if not exists ACT_FK_VAR_EXE
    foreign key (EXECUTION_ID_)
      references ACT_RU_EXECUTION;

alter table if exists ACT_RU_VARIABLE
  add constraint if not exists ACT_FK_VAR_PROCINST
    foreign key (PROC_INST_ID_)
      references ACT_RU_EXECUTION;

alter table if exists ACT_RU_JOB
  add constraint if not exists ACT_FK_JOB_EXECUTION
    foreign key (EXECUTION_ID_)
      references ACT_RU_EXECUTION;

alter table if exists ACT_RU_JOB
  add constraint if not exists ACT_FK_JOB_PROCESS_INSTANCE
    foreign key (PROCESS_INSTANCE_ID_)
      references ACT_RU_EXECUTION;

alter table if exists ACT_RU_JOB
  add constraint if not exists ACT_FK_JOB_PROC_DEF
    foreign key (PROC_DEF_ID_)
      references ACT_RE_PROCDEF;

alter table if exists ACT_RU_TIMER_JOB
  add constraint if not exists ACT_FK_TIMER_JOB_EXECUTION
    foreign key (EXECUTION_ID_)
      references ACT_RU_EXECUTION;

alter table if exists ACT_RU_TIMER_JOB
  add constraint if not exists ACT_FK_TIMER_JOB_PROCESS_INSTANCE
    foreign key (PROCESS_INSTANCE_ID_)
      references ACT_RU_EXECUTION;

alter table if exists ACT_RU_TIMER_JOB
  add constraint if not exists ACT_FK_TIMER_JOB_PROC_DEF
    foreign key (PROC_DEF_ID_)
      references ACT_RE_PROCDEF;

alter table if exists ACT_RU_SUSPENDED_JOB
  add constraint if not exists ACT_FK_SUSPENDED_JOB_EXECUTION
    foreign key (EXECUTION_ID_)
      references ACT_RU_EXECUTION;

alter table if exists ACT_RU_SUSPENDED_JOB
  add constraint if not exists ACT_FK_SUSPENDED_JOB_PROCESS_INSTANCE
    foreign key (PROCESS_INSTANCE_ID_)
      references ACT_RU_EXECUTION;

alter table if exists ACT_RU_SUSPENDED_JOB
  add constraint if not exists ACT_FK_SUSPENDED_JOB_PROC_DEF
    foreign key (PROC_DEF_ID_)
      references ACT_RE_PROCDEF;

alter table if exists ACT_RU_DEADLETTER_JOB
  add constraint if not exists ACT_FK_DEADLETTER_JOB_EXECUTION
    foreign key (EXECUTION_ID_)
      references ACT_RU_EXECUTION;

alter table if exists ACT_RU_DEADLETTER_JOB
  add constraint if not exists ACT_FK_DEADLETTER_JOB_PROCESS_INSTANCE
    foreign key (PROCESS_INSTANCE_ID_)
      references ACT_RU_EXECUTION;

alter table if exists ACT_RU_DEADLETTER_JOB
  add constraint if not exists ACT_FK_DEADLETTER_JOB_PROC_DEF
    foreign key (PROC_DEF_ID_)
      references ACT_RE_PROCDEF;

alter table if exists ACT_RU_EVENT_SUBSCR
  add constraint if not exists ACT_FK_EVENT_EXEC
    foreign key (EXECUTION_ID_)
      references ACT_RU_EXECUTION;

alter table if exists ACT_RE_MODEL
  add constraint if not exists ACT_FK_MODEL_SOURCE
    foreign key (EDITOR_SOURCE_VALUE_ID_)
      references ACT_GE_BYTEARRAY (ID_);

alter table if exists ACT_RE_MODEL
  add constraint if not exists ACT_FK_MODEL_SOURCE_EXTRA
    foreign key (EDITOR_SOURCE_EXTRA_VALUE_ID_)
      references ACT_GE_BYTEARRAY (ID_);

alter table if exists ACT_RE_MODEL
  add constraint if not exists ACT_FK_MODEL_DEPLOYMENT
    foreign key (DEPLOYMENT_ID_)
      references ACT_RE_DEPLOYMENT (ID_);

alter table if exists ACT_PROCDEF_INFO
  add constraint if not exists ACT_FK_INFO_JSON_BA
    foreign key (INFO_JSON_ID_)
      references ACT_GE_BYTEARRAY (ID_);

alter table if exists ACT_PROCDEF_INFO
  add constraint if not exists ACT_FK_INFO_PROCDEF
    foreign key (PROC_DEF_ID_)
      references ACT_RE_PROCDEF (ID_);

alter table if exists ACT_PROCDEF_INFO
  add constraint if not exists ACT_UNIQ_INFO_PROCDEF
    unique (PROC_DEF_ID_);

insert into ACT_GE_PROPERTY
values ('schema.version', '7.1.0.2', 1) ON DUPLICATE KEY UPDATE NAME_ = NAME_;

insert into ACT_GE_PROPERTY
values ('schema.history', 'create(7.1.0.2)', 1) ON DUPLICATE KEY UPDATE NAME_ = NAME_;
...
CREATE TABLE IF NOT EXISTS FLW_EVENT_DEPLOYMENT (ID_ VARCHAR(255) NOT NULL, NAME_ VARCHAR(255), CATEGORY_ VARCHAR(255), DEPLOY_TIME_ TIMESTAMP, TENANT_ID_ VARCHAR(255), PARENT_DEPLOYMENT_ID_ VARCHAR(255), CONSTRAINT PK_FLW_EVENT_DEPLOYMENT PRIMARY KEY (ID_));

CREATE TABLE IF NOT EXISTS FLW_EVENT_RESOURCE (ID_ VARCHAR(255) NOT NULL, NAME_ VARCHAR(255), DEPLOYMENT_ID_ VARCHAR(255), RESOURCE_BYTES_ BLOB, CONSTRAINT PK_FLW_EVENT_RESOURCE PRIMARY KEY (ID_));

CREATE TABLE IF NOT EXISTS FLW_EVENT_DEFINITION (ID_ VARCHAR(255) NOT NULL, NAME_ VARCHAR(255), VERSION_ INT, KEY_ VARCHAR(255), CATEGORY_ VARCHAR(255), DEPLOYMENT_ID_ VARCHAR(255), TENANT_ID_ VARCHAR(255), RESOURCE_NAME_ VARCHAR(255), DESCRIPTION_ VARCHAR(255), CONSTRAINT PK_FLW_EVENT_DEFINITION PRIMARY KEY (ID_));

CREATE UNIQUE INDEX IF NOT EXISTS ACT_IDX_EVENT_DEF_UNIQ ON FLW_EVENT_DEFINITION(KEY_, VERSION_, TENANT_ID_);

CREATE TABLE IF NOT EXISTS FLW_CHANNEL_DEFINITION (ID_ VARCHAR(255) NOT NULL, NAME_ VARCHAR(255), VERSION_ INT, KEY_ VARCHAR(255), CATEGORY_ VARCHAR(255), DEPLOYMENT_ID_ VARCHAR(255), CREATE_TIME_ TIMESTAMP, TENANT_ID_ VARCHAR(255), RESOURCE_NAME_ VARCHAR(255), DESCRIPTION_ VARCHAR(255), CONSTRAINT PK_FLW_CHANNEL_DEFINITION PRIMARY KEY (ID_));
...
alter table if exists ACT_ID_MEMBERSHIP
  add constraint if not exists ACT_FK_MEMB_GROUP
    foreign key (GROUP_ID_)
      references ACT_ID_GROUP;

alter table if exists ACT_ID_MEMBERSHIP
  add constraint if not exists ACT_FK_MEMB_USER
    foreign key (USER_ID_)
      references ACT_ID_USER;

alter table if exists ACT_ID_PRIV_MAPPING
  add constraint if not exists ACT_FK_PRIV_MAPPING
...
alter table if exists ACT_ID_PRIV
  add constraint if not exists ACT_UNIQ_PRIV_NAME
    unique (NAME_);
