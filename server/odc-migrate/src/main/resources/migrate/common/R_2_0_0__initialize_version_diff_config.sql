...
insert into `odc_version_diff_config`(`config_key`,`db_mode`,`config_value`,`min_version`,`gmt_create`) values('support_materialized_view', 'OB_MYSQL', 'true', '4.3.5.1', CURRENT_TIMESTAMP) ON DUPLICATE KEY update `config_key`=`config_key`;
insert into `odc_version_diff_config`(`config_key`,`db_mode`,`config_value`,`min_version`,`gmt_create`) values('support_materialized_view', 'OB_ORACLE', 'true', '4.3.5.1', CURRENT_TIMESTAMP) ON DUPLICATE KEY update `config_key`=`config_key`;
