...
CREATE TABLE IF NOT EXISTS `connect_database_object` (
  ...
  `type` varchar(32) NOT NULL COMMENT 'Type of the database object, optional values: TABLE, VIEW, FUNCTION, PROCEDURE, PACKAGE,  PACKAGE_BODY, TRIGGER, TYPE, SEQUENCE, SYNONYM, PUBLIC_SYNONYM',
