...
alter table `connect_database` add column `connect_type` varchar(128) DEFAULT NULL COMMENT 'database connect type, enum values: OB_MYSQL, OB_ORACLE, CLOUD_OB_MYSQL, CLOUD_OB_ORACLE, etc.';
