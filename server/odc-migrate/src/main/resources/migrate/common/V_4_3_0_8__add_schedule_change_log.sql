...
`old_schedule_parameters` text NULL COMMENT 'JSON of the schedule parameters before the change',
`new_schedule_parameters` text NULL COMMENT 'JSON of the schedule parameters after the change',
