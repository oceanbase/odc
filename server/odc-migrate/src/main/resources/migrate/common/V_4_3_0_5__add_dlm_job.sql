CREATE TABLE `dlm_job` (
  ...
  `source_database_id` bigint NOT NULL COMMENT 'ID of the source database',
  `target_database_id` bigint NULL COMMENT 'ID of the target database',
...
INDEX `idx_dlm_job_schedule_task_id` USING BTREE (`schedule_task_id`) LOCAL,
CONSTRAINT `pk_dlm_job_id` PRIMARY KEY (`id`),
CONSTRAINT `uk_dlm_job_dlm_job_id` UNIQUE (`dlm_job_id`)
);

CREATE TABLE `dlm_job_statistic` (
