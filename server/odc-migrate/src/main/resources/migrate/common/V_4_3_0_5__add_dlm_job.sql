CREATE TABLE IF NOT EXISTS `dlm_table_unit` (
  ...
  `start_time` varchar(120) NOT NULL COMMENT 'The start time of the dlm table unit',
  `end_time` varchar(120) NOT NULL COMMENT 'The end time  of the dlm table unit',
  ...
  `statistic` text NULL COMMENT 'JSON formatted for task execution details',
