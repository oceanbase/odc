alter table `iam_permission` add `resource_type` varchar(64) default null comment 'ResourceType: ODC_DATABASE,ODC_TABLE,ODC_COLUMN ';
alter table `iam_permission` add `resource_id` bigint(20) default null comment 'resource id';
