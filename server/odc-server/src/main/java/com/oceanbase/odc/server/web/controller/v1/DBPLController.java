...
public class DBPLController {
    ...
    public OdcResult<OdcSqlExecuteResult> compile(@PathVariable String sid, @RequestBody PLIdentity params) {
        return OdcResult.ok(this.plService.compile(sessionService.nullSafeGet(SidUtils.getSessionId(sid)), params));
    }
    ...
    public OdcResult<CallProcedureResp> callProcedure(@PathVariable String sid,
        ...
        return OdcResult
                .ok(this.plService.callProcedure(sessionService.nullSafeGet(SidUtils.getSessionId(sid)),
                        callProcedureReq));
    }
    ...
    public OdcResult<CallFunctionResp> callFunction(@PathVariable String sid,
        ...
        return OdcResult
                .ok(this.plService.callFunction(sessionService.nullSafeGet(SidUtils.getSessionId(sid)),
                        callFunctionReq));
    }
