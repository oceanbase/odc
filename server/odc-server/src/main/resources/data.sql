...
INSERT INTO config_system_configuration(`key`, `value`, `description`) VALUES('odc.task.pre-check.max-sql-count',
 '1000', '预检查时所允许检查的 SQL 的最大行数，超过该上限将终止预检查并将检查结果置为最高风险等级，默认值：1000，修改后重启生效') ON DUPLICATE KEY UPDATE `id`=`id`;
