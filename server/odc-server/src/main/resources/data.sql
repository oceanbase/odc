...
INSERT INTO config_system_configuration ( `key`, `value`, `description` ) VALUES( 'odc.iam.auth.alipay.failed-login-lock-timeout-seconds', '600', '账户被锁定时常，默认 600 秒，如果该值小于等于 0 意味着不锁定' ) ON DUPLICATE KEY UPDATE `id` = `id`;
