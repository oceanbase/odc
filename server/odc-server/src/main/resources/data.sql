...
INSERT INTO config_system_configuration ( `key`, `value`, `description` ) VALUES( 'odc.task-framework.k8s-properties.max-node-count', '22', 'k8s max node count' ) ON DUPLICATE KEY UPDATE `id` = `id`;
