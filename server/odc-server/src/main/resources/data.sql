...
update `id`=`id`;
insert into `config_system_configuration` (`key`, `value`, `application`, `profile`, `label`, `description`)
VALUES ('odc.notification.host-black-list', 'The Hosts in this black list are NOT allowed to prevent SSRF security vulnerabilities. The black list is empty by default, allowing access to all Hosts.', 'odc', 'default', 'master', '') ON DUPLICATE KEY update `id`=`id`;
