...
INSERT INTO config_system_configuration ( `key`, `value`, `description` ) VALUES( 'odc.task-framework.job-pull-result-interval-seconds', '60', 'job pull result interval seconds' ) ON DUPLICATE KEY UPDATE `id` = `id`;
