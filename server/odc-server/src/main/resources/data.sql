...
INSERT INTO config_system_configuration ( `key`, `value`, `description` ) VALUES( 'odc.task-framework.k8s-properties.pod-pending-timeout-seconds', '7200', 'pod will be destroyed if pending exceed this time, default time is 2h' ) ON DUPLICATE KEY UPDATE `id` = `id`;
