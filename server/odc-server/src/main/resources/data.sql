...
INSERT INTO config_system_configuration ( `key`, `value`, `description` ) VALUES( 'odc.task-framework.running-job-total-memory-threshold-in-mb', '0', 'running job total memory threshold size MB, for controller schedule rate in process model' ) ON DUPLICATE KEY UPDATE `id` = `id`;
