...
INSERT INTO config_system_configuration ( `key`, `value`, `description` ) VALUES( 'odc.task-framework.k8s-properties.node-cpu', '', 'single k8s node cpu count' ) ON DUPLICATE KEY UPDATE `id` = `id`;
INSERT INTO config_system_configuration ( `key`, `value`, `description` ) VALUES( 'odc.task-framework.k8s-properties.node-mem-in-mb', '', 'single k8s node memory size, unit is MB' ) ON DUPLICATE KEY UPDATE `id` = `id`;
