...
INSERT INTO config_system_configuration ( `key`, `value`, `description` ) VALUES( 'odc.task-framework.k8s-properties.node-mem', '', 'k8s node memory' ) ON DUPLICATE KEY UPDATE `id` = `id`;
