...
INSERT INTO config_system_configuration(`key`, `value`, `description`) VALUES('odc.iam.permission.expired-clean-interval-millis',
 '180000', 'Time interval for clearing expired permissions, in milliseconds, default 3 minutes') ON DUPLICATE KEY UPDATE `id`=`id`;
