...
INSERT INTO config_system_configuration ( `key`, `value`, `description` ) VALUES( 'odc.task-framework.k8s-properties.node-count', '', 'k8s node count' ) ON DUPLICATE KEY UPDATE `id` = `id`;
