...
INSERT INTO config_system_configuration ( `key`, `value`, `description` ) VALUES( 'odc.task-framework.system-reserve-min-free-memory-size-in-mb', '1025', 'system reserve min free memory size in mb' ) ON DUPLICATE KEY UPDATE `id` = `id`;
