CREATE TABLE `${const:com.oceanbase.odc.service.partitionplan.PartitionPlanServiceTest.MYSQL_REAL_RANGE_TABLE_NAME}` (
...
CREATE TABLE `${const:com.oceanbase.odc.service.partitionplan.PartitionPlanServiceTest.MYSQL_OVERLAP_RANGE_TABLE_NAME}` (
  `id` bigint(20) unsigned NOT NULL,
  `gmt_create` datetime NOT NULL,
  `gmt_modified` datetime NOT NULL,
  `datekey` int(11) NOT NULL,
...
partition p20220830 values less than (20220730, '2022-07-30'),
partition p20240130 values less than (20220731, '2022-07-31'));