...
/**
 * Test cases for {@link V42416PartitionPlanMigrateTest}
 *
 * @author yh263208
 * @date 2024-03-12 11:22
 * @since ODC_release_4.2.4
 */
public class V42416PartitionPlanMigrateTest extends ServiceTestEnv {
    ...
    public void migrate_historicalPartiPlanExists_succeed() {
        JdbcMigratable jdbcMigratable = new V42416PartitionPlanMigrate();
