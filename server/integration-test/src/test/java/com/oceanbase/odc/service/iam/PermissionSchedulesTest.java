...
public class PermissionSchedulesTest extends ServiceTestEnv {
    ...
    public void test_clearExpiredPermission() {
        ...
        createPermissionEntity("alter", "ODC_DATABASE:2", new Date(currentTime - 91 * 24 * 60 * 60 * 1000L));
        createPermissionEntity("alter", "ODC_DATABASE:2", new Date(currentTime - 89 * 24 * 60 * 60 * 1000L));
        createPermissionEntity("alter", "ODC_DATABASE:2", new Date(currentTime - 88 * 24 * 60 * 60 * 1000L));
    ...
    private void createPermissionEntity(String action, String resourceIdentifier, Date expireTime) {
        ...
        entity.setSourceType(PermissionSourceType.USER_AUTHORIZATION);
