...
import com.oceanbase.odc.service.onlineschemachange.ddl.OscOBOracleAccessor;
 ...
 * @since 4.2.3
 */
public class OscOBOracleAccessorTest extends OBOracleOscTestEnv {


    @Test
    public void listUsersDetail_SpecifyUsername_Success() {
        OscOBOracleAccessor accessor = new OscOBOracleAccessor(jdbcTemplate);
