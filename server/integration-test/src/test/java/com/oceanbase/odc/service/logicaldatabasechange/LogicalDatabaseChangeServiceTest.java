 ...
 */
package com.oceanbase.odc.service.logicaldatabasechange;
...
public class LogicalDatabaseChangeServiceTest extends ServiceTestEnv {
    ...
    @Test
    public void testCreateLogicalDatabase() {
    ...
    @Test
    public void testLogicalDatabaseChange() {
        CreateLogicalDatabaseReq req = new CreateLogicalDatabaseReq();
        req.setProjectId(PROJECT_ID);
        req.setAlias(LOGICAL_DATABASE_ALIAS);
        req.setName(LOGICAL_DATABASE_NAME);
        ...
        databaseIds.addAll(Arrays.asList(PHYSICAL_DATABASE_ID));
        req.setPhysicalDatabaseIds(databaseIds);
        Database logicalDB = logicalDatabaseService.create(req);
