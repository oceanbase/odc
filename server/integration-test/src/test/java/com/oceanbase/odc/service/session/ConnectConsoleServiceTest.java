...
// ConnectionSession testConnectionSession =
...
// ConnectionSession testConnectionSession =
/// TestConnectionUtil.getTestConnectionSession(ConnectType.OB_MYSQL);
// if (VersionUtils.isLessThanOrEqualsTo(ConnectionSessionUtil.getVersion(testConnectionSession),
/// "4.2")) {
// return;
// }
// SyncJdbcExecutor syncJdbcExecutor = testConnectionSession.getSyncJdbcExecutor(
...
// injectExecuteContext(sessionId, resp.getRequestId(),
/// JdbcGeneralResult.successResult(SqlTuple.newTuple(sql)));
// List<SqlExecuteResult> resultList = consoleService.getMoreResults(sessionId,
/// resp.getRequestId()).getResults();
//
...
// String sql = "kill session /*";
// JdbcGeneralResult failedResult = JdbcGeneralResult.failedResult(SqlTuple.newTuple(sql), new
/// Exception("test"));
...
// VirtualElement elt = new CommonVirtualElement("tableId", rowId, colId, "test_type", "test_name",
/// metaData);
// table.put(elt);
...
// Mockito.when(sessionService.nullSafeGet(testConnectionSession.getId(),
/// true)).thenReturn(testConnectionSession);
...
// }
//
// private SqlAsyncExecuteReq getEditPLAsyncExecuteReq(String editTestProcedure, String plName,
/// DBObjectType plType) {
...
// editProcedureReq.setObjectName(plName);
// editProcedureReq.setObjectType(plType);
...
//
// public TestConnectionSession(String id, ConnectType connectType, ConnectionConfig
/// connectionConfig,
...
//
// @Override
// public AsyncJdbcExecutor getAsyncJdbcExecutor(String dataSourceName) throws
