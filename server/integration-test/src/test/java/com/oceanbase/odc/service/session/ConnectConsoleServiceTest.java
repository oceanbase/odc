...
public class ConnectConsoleServiceTest extends ServiceTestEnv {
    ...
    public void getAsyncResult_killSessionSql_successResult() throws Exception {
        Mockito.when(organizationConfigFacade.getDefaultQueryLimit()).thenReturn(1000);
        Mockito.when(organizationConfigFacade.getDefaultMaxQueryLimit()).thenReturn(1000);
