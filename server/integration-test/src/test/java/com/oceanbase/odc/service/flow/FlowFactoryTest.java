...
public class FlowFactoryTest extends ServiceTestEnv {
    ...
    private FlowTaskInstance createTaskInstance(Long flowInstanceId, ExecutionStrategyConfig config) {
        return new FlowTaskInstance(TaskType.ASYNC, authenticationFacade.currentOrganizationId(), flowInstanceId,
                config, false, true, type -> TestFlowRuntimeTaskImpl.class, flowAdaptor, new LocalEventPublisher(),
